                ...
                <div class="ibox">
                    <div class="ibox-content">
                        ...
                        <div style="margin-bottom:50px;">
                            <!-- 心情 -->
                            <img src="/Public/Uploads/<?php echo ($articleInfo["pic"]); ?>" alt="" style="width:100%">
                            <!--心情结束-->
                        ...
                        <div id = "beijing">
                            <p style="font-size:14px;" class="text2" >
                                ...
                                <?php echo (strip_tags($articleInfo["content"])); ?>
...
<script>
    $(function() {
        $("#socialShare").socialShare({
            ...
            url:'http://<?php echo $_SERVER["SERVER_NAME"];?>/index.php?m=home&c=article&a=index&id=22',
    ...
    $("#luandian").click(function(){
        $('body').html("<center><h1 style = 'color:#fff;'>都TM告诉你不要乱点了，不相信我是吧，看你现在怎么办</h1><a href = '#' onclick = 'javascript:history.go(-1)' style = 'color:#2f4050;'>返回</a></center>");
                        ...
                        <link href="/Public/wenzixiaoguo/css/animate.css" rel="stylesheet">
                        <script src="/Public/wenzixiaoguo/js/jquery.lettering.js"></script>
                        <script src="/Public/wenzixiaoguo/js/jquery.textillate.js"></script>
                        <script>
                            $(function () {
                                $('.text2').textillate({
